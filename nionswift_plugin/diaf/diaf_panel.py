...
class diafView:
    ...
    def __init__(self, instrument:diaf_inst.diafDevice):
        ...
        self.m1_slider = ui.create_slider(name='m1_slider', value='@binding(instrument.m1_f)', minimum=40000, maximum=130000, on_slider_released='slider_release')
        self.m2_slider_label=ui.create_label(name='m2_slider_label', text='@binding(instrument.m2_f)')
        self.m2_slider = ui.create_slider(name='m2_slider', value='@binding(instrument.m2_f)', minimum=65000, maximum=95000, on_slider_released='slider_release')
        ...
        self.m3_slider = ui.create_slider(name='m3_slider', value='@binding(instrument.m3_f)', minimum=50000, maximum=140000, on_slider_released='slider_release')
        self.m4_slider_label=ui.create_label(name='m4_slider_label', text='@binding(instrument.m4_f)')
        self.m4_slider = ui.create_slider(name='m4_slider', value='@binding(instrument.m4_f)', minimum=40000, maximum=70000, on_slider_released='slider_release')
