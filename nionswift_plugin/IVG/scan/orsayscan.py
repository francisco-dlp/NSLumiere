...
class orsayScan(object):
    ...
    def __initialize_library(self):
        ...
        self.__OrsayScanSetInputs = _buildFunction(_library.OrsayScanSetInputs,
                                                   [c_void_p, c_int, c_int, POINTER(c_int)],
                                                   c_bool)

        # int SCAN_EXPORT OrsayScanGetInputs(void* o, int gene, int *inputs);
        self.__OrsayScanGetInputs = _buildFunction(_library.OrsayScanGetInputs, [c_void_p, c_int, POINTER(c_int)],
                                                   c_int)
        ...
        self.__OrsayScanStartImaging = _buildFunction(_library.OrsayScanStartImaging,
        ...
        self.__OrsayScanSetImagingMode = _buildFunction(_library.OrsayScanSetImagingMode, [c_void_p, c_int, c_int],
                                                        None);
        ...
        self.__OrsayScanSetScale = _buildFunction(_library.OrsayScanSetScale, [c_void_p, c_int, c_double, c_double],
                                                  None)

        # void SCAN_EXPORT OrsayScanSetImagingKind(void *o, int gene, int kind);
        self.__OrsayScanSetImagingKind = _buildFunction(_library.OrsayScanSetImagingKind, [c_void_p, c_int, c_int],
                                                        None)
        ...
        self.__OrsayScanSetVideoOffset = _buildFunction(_library.OrsayScanSetVideoOffset, [c_void_p, c_int, c_double],
                                                        None)
        ...
        self.__OrsayScanregisterLocker = _buildFunction(_library.OrsayScanRegisterDataLocker, [c_void_p, LOCKERFUNC],
                                                        None)
        # void SCAN_EXPORT OrsayScanRegisterDataUnlocker(void *o, void(*UnLockScanDataPointer)(int gene, bool newdata));
        self.__OrsayScanregisterUnlocker = _buildFunction(_library.OrsayScanRegisterDataUnlocker,
        ...
        self.__OrsayScanSetProbeAt = _buildFunction(_library.OrsayScanSetProbeAt, [c_void_p, c_int, c_int, c_int],
                                                    c_bool)
        ...
        self.__OrsayScanAlGun = _buildFunction(_library.OrsayScanAlGun,
                                               [c_void_p, c_double, c_double, c_double, c_double],
                                               None)
        ...
        self.__OrsayScanSetLaser = _buildFunction(_library.OrsayScanSetLaser,
        ...
        self.__OrsayScanGetClockSimulationTime = _buildFunction(_library.GetClockSimulationTime, [c_void_p, c_int],
                                                                c_double)
        #	void SCAN_EXPORT SetClockSimulationTime(void *o, int gene, double dt);
        self.__OrsayScanSetClockSimulationTime = _buildFunction(_library.SetClockSimulationTime,
    ...
    def __init__(self, gene, scandllobject=0, vg=False):
        ...
        self.__OrsayScangetVersion(self.orsayscan, byref(cproduct), byref(crevision), byref(cserialnumber),
    ...
    def getImageArea(self) -> (bool, int, int, int, int, int, int):
        ...
        res = self.__OrsayScangetImageArea(self.orsayscan, self.gene, byref(sx), byref(sy), byref(stx), byref(ex),
                                           byref(sty), byref(ey))
