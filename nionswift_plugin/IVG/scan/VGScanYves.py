...
class Device:
    ...
    def __get_channels(self) -> typing.List[Channel]:
        return [Channel(0, "HAADF", True), Channel(1, "BF", True)]

    def __get_initial_profiles(self) -> typing.List[scan_base.ScanFrameParameters]:
        profiles = list()
        profiles.append(scan_base.ScanFrameParameters({"size": (512, 512), "pixel_time_us": 0.25, "fov_nm": 32000.}))
    ...
    def set_frame_parameters(self, frame_parameters: scan_base.ScanFrameParameters) -> None:
        ...
        if frame_parameters['subscan_pixel_size']:
            ...
            self.p2 = int(frame_parameters['subscan_fractional_center'][1]*self.p0-frame_parameters['subscan_pixel_size'][1]/2)
            self.p4 = int(frame_parameters['subscan_fractional_center'][0]*self.p1-frame_parameters['subscan_pixel_size'][0]/2)
