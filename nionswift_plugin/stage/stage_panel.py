...
class stageView:
    ...
    def __init__(self, instrument:stage_inst.stageDevice):
        ...
        self.x_slider=ui.create_slider(name='x_slider', value='@binding(instrument.x_pos_f)', minimum=-1200, maximum=1200, on_slider_released='slider_release')
        ...
        self.y_slider = ui.create_slider(name='y_slider', value='@binding(instrument.y_pos_f)', minimum=-1200, maximum=1200, on_slider_released='slider_release')
