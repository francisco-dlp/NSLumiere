...
class stagehandler:
    ...
    def slider_release(self, widget):
        widget.maximum=widget.value+25
        widget.minimum=widget.value-25

    def total_range(self, widget):
        self.x_slider.maximum = 800
        self.x_slider.minimum = -800

        self.y_slider.maximum = 800
        self.y_slider.minimum = -800
...
class stageView:
    ...
    def __init__(self, instrument:stage_inst.stageDevice):
        ...
        self.x_slider=ui.create_slider(name='x_slider', value='@binding(instrument.x_pos_f)', minimum=-800, maximum=800, on_slider_released='slider_release')
        ...
        self.y_slider = ui.create_slider(name='y_slider', value='@binding(instrument.y_pos_f)', minimum=-800, maximum=800, on_slider_released='slider_release')
